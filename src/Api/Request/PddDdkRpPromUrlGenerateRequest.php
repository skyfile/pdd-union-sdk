...
class PddDdkRpPromUrlGenerateRequest extends PopBaseHttpRequest
{
    ...
    /**
     * @JsonProperty(\Com\Pdd\Pop\Sdk\Api\Request\PddDdkRpPromUrlGenerateRequest_DiySpRedPacketParam, "diy_sp_red_packet_param")
     */
    ...
    protected function setUserParams(&$params)
    {
        ...
        $this->setUserParam($params, 'diy_sp_red_packet_param', $this->diySpRedPacketParam);
    }
    ...
    public function setDiySpRedPacketParam($diySpRedPacketParam)
    {
...
class PddDdkRpPromUrlGenerateRequest_DiySpRedPacketParam extends PopBaseJsonEntity
{
    ...
    public function setGoodsSign($goods_sign)
    {
        $this->goodsSign = $goods_sign;
    }
